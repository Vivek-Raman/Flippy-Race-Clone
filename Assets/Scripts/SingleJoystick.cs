...
calculates and outputs a normalized direction vector for another script to use in order to control movement of a game object (example, a player character or any desired game object)
...
public class SingleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    // outputs the direction vector, use this public function from another script to control movement of a game object (such as a player character or any desired game object)
